...
> **Судьба библиотеки (2026-09-03, активный план `docs/plans/2026-09-03-ai-builder-unification-part-1.md`):**
> эта библиотека — спящий дубликат. Владелец генерирующих промптов — `generation-engine/src/prompts/`
> (ADR-0052 сделает его единственным — hard switch, Часть 2 Task 7). В hard-switch PR библиотека удаляется целиком: подключённые
