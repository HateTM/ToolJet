...
- **Active plan** — [`docs/plans/2026-09-03-ai-builder-unification-part-1.md`](docs/plans/2026-09-03-ai-builder-unification-part-1.md): текущий план унификации AI Builder (модернизация стэка 2026 → ADR-0052 hard switch → sync-гварды; Часть 2: каталог движка 36 типов, деплой, удаление fallback, полный фронтенд). Сверяться с ним **до** любой работы в области AI Builder / `generation-engine/` — статусы задач в чекбоксах плана. Note: hard-switch ADR renumbered 0050→0052 (0050 was claimed by the NestJS-12-defer ADR before this plan reference was updated).
