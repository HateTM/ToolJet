...
// not as a separate up-front LLD stage. Content is left for the ticket that implements
// this stage.
// TODO (#82): replace with the real LLD system prompt.
export const LLD_SYSTEM_PROMPT = `TODO (#82): LLD (schema design) stage system prompt — not yet implemented.`;
